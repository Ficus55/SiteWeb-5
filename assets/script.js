...
//open search form
document.querySelector(".site-nav__icon .fa-magnifying-glass").addEventListener("click", () => {
    document.querySelector(".site-header").classList.toggle("search-active");
    document.body.classList.toggle("disable_scroll");
});

document.querySelector(".search-header-close").addEventListener("click", () => {
    document.querySelector(".site-header").classList.toggle("search-active");
    document.body.classList.toggle("disable_scroll");
});

document.addEventListener("click", (event) => {
    if (event.target.classList.contains("search-active")) {
        document.querySelector(".site-header").classList.toggle("search-active");
        document.body.classList.toggle("disable_scroll");
    }
});
